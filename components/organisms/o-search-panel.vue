<template>
  <div class="o-search-panel">
    <div class="o-search-panel__search-bar">
      <SfSearchBar
        v-model="search"
    ...
    <div v-else class="container">
      ...
      <div class="products">
        ...
        <SfButton
          v-if="OnlineOnly && readMore && visibleProducts.length >= size"
...
import { SfHeading, SfButton, SfList, SfMenuItem, SfProductCard, SfSearchBar } from '@storefront-ui/vue';
