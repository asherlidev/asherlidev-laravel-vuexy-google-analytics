    ...
    <div class="sb-car-locator">
        <SfCallToAction :image="leftImage">
            <template #description>
                <h2 class="sub-title">{{ content.left_title }}</h2>
                <div class="button-container">
                    <div class="hero-selector-modal">
                        <SfButton class="sf-button sf-button--outline" @click="onClick('left')">
                            <div class="search-button-content">{{ content.left_button_text }}</div>
                        </SfButton>
                    </div>
                </div>
            </template>
        ...
        <SfCallToAction :image="rightImage">
            <template #description>
                <h2 class="sub-title">{{ content.right_title }}</h2>
                <div class="button-container">
                    <div class="hero-selector-modal">
                        <SfButton class="sf-button sf-button--outline" @click="onClick('left')">
                            <div class="search-button-content">{{ content.right_button_text }}</div>
                        </SfButton>
                    </div>
                </div>
            </template>
