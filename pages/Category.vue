  ...
  <div id="category">
    ...
    <div class="main section">
      <div class="sidebar desktop-only">
        <div class="navbar__aside desktop-only" v-if="nationalCode">
      ...
      <div class="products">
        <SfHeading :title="getCategoryTitle" class="navbar__title" />
        <SfHeading
        ...
        <template v-else>
          <lazy-hydrate :trigger-hydration="!loading">
            ...
            >
              <SfProductCard
                v-for="(product, key) in currentPageProducts"
                :key="key"
                :title="product.title"
                :image="product.image"
...
export default {
  ...
  computed: {
    ...
    nationalCode () {
      return this.activeVehicle ? this.activeVehicle.National_code : false;
    },
    getCategoryTitle () {
  ...
  methods: {
    ...
    async changePage (page = this.currentPage) {
      ...
      if (Object.keys(this.activeVehicle).length) {
        let national_code = [];
        national_code.push({
...
.products {
  ::v-deep .sf-image {
    --_image-width: 500 !important;
    --_image-height: 500 !important;
    img {
  ...
  ::v-deep .products__product-card {
    --product-card-max-width: 33.33333%;
    margin: 0;
  }
